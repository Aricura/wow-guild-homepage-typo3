...
/**
 * Model representing a single record of the pages_language_overlay database table.
 *
 * @property int    uid
 * @property int    pid
 ...
 */
class PageOverlay extends AbstractModel
{
	 ...
	 * @var string
	 */
	protected $table = 'pages_language_overlay';
}
